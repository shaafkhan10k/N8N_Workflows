...
# Each directory in this repository represents an independent n8n automation project (such as the `HR Recruitment Workflow`)\[cite: 2]. Inside each project folder, you will find:
...
# This project is licensed under the MIT License\[cite: 2]. See the `LICENSE` file for details\[cite: 2].
